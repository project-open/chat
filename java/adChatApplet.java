...
public class adChatApplet extends Applet implements ActionListener, adChatClient{
	...
	int private_button_width = 30;
	int private_button_height = 25;

	int ignore_button_width = 40;
	...
	*/
	...
	Image icon = getImage(getDocumentBase(), "fish2.gif");
	...
	logoff_button.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent ae) {
                        URL exitURL = null;
                        try {
                            exitURL = new URL(getCodeBase().toString());
